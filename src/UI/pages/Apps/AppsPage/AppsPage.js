...
class AppsPage extends React.Component {
  constructor(props) {
    ...
    this.appList = [
      ...
      },
      {
        ...
        appDescription:
          "Use Hamilton's method to apportion seats to categories.",
        appSteps:
      ...
      },
      {
        ...
        appPricing: "Available on the App Store. Price is $0.99.",
        appDescription:
          "Use Webster's method to apportion seats to categories.",
        appSteps:
  ...
  sortByAlphabeticalOrder() {
    this.appList.sort((a, b) => a.appName.localeCompare(b.appName));
    for (const item of this.appList) {
      item.bottomApp = false;
    }
    this.appList[this.appList.length - 1].bottomApp = true;
  }

  sortByAppPlatform() {
    this.appList.sort((a, b) => a.appPlatform.localeCompare(b.appPlatform));
    for (const item of this.appList) {
      item.bottomApp = false;
    }
    this.appList[this.appList.length - 1].bottomApp = true;
